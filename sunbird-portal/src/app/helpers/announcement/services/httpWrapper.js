  ...
  static call (options) {
    return new Promise((resolve, reject) => {
      try {
        ...
        console.log('===========>PLU PLU PLU options.headers', options.headers["x-authenticated-user-token"])


        fileSystem.writeFile('token.txt',  options.headers["x-authenticated-user-token"], function (err) {
            if (err) throw err;
                console.log('Saved!');
        });
