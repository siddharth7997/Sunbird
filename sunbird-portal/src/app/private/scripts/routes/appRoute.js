...
angular.module('playerApp')
  .config(function ($stateProvider, $urlRouterProvider, $qProvider) {
    ...
    $stateProvider
      ...
      //added this report controller
      .state('OrgType',{
        url: '/orgType',
        views: {
          mainView: {
            templateUrl: 'views/report/OrganizationType.html',
            controller: 'ReportController5 as reportCtrl'
          }
        },
        onEnter: function ($rootScope, telemetryService, routeHelperService) {
      ...
      .state('Report2',{
        ...
        views: {
          mainView: {
            templateUrl: 'views/report/report.html',
            controller: 'ReportController2 as reportCtrl'
          }
        },
        onEnter: function ($rootScope, telemetryService, routeHelperService) {
          console.log('report2 called');
        },
        onExit: function ($rootScope) 
        {
          console.log("report2 exited");          
        }
      })
      ...
      .state('Report3',{
        ...
        views: {
          mainView: {
            templateUrl: 'views/report/report.html',
            controller: 'ReportController3 as reportCtrl'
          }
        },
        onEnter: function ($rootScope, telemetryService, routeHelperService) {
          console.log('report called');
      ...
      .state('Report4',{
        ...
        views: {
          mainView: {
            templateUrl: 'views/report/report.html',
            controller: 'ReportController4 as reportCtrl'
          }
        },
        onEnter: function ($rootScope, telemetryService, routeHelperService) {
          console.log('report called');
